(function(){
  ...
  overlay.innerHTML = '<div style="position:fixed;inset:0;z-index:99999;background:#F7F7F7;display:flex;align-items:center;justify-content:center;flex-direction:column;font-family:Inter,sans-serif;transition:opacity .38s ease">' +
    ...
    '<div style="position:absolute;top:28%;left:50%;transform:translateX(-50%);width:min(480px,90vw);height:280px;pointer-events:none;background:radial-gradient(ellipse,rgba(80,0,179,.08) 0%,transparent 70%)"></div>' +
    '<div style="position:relative;z-index:1;text-align:center">' +
      '<div style="margin:0 auto 20px;animation:lhPop .5s cubic-bezier(.34,1.56,.64,1) both">' +
        '<img src="/new-logo.png" alt="LeadEmpire" style="height:min(100px,25vw);width:auto;object-fit:contain;display:block">' +
      '</div>' +
      ...
      '<div style="width:min(200px,50vw);height:4px;background:#E2E8F0;border-radius:99px;overflow:hidden;margin:0 auto 14px;animation:lhUp .4s ease .3s both">' +
